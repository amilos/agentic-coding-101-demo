...
# "sql2025" container on localhost:1433, sa / Password123. This keeps the 3-minute
...
env "local" {
  src = "file://schema.hcl"
  url = "sqlserver://sa:Password123@localhost:1433?database=NorthBank"

  # Scratch database Atlas rewrites freely — must be empty and dedicated.
  dev = "sqlserver://sa:Password123@localhost:1433?database=NorthBank_dev"
